				...
				while(more) {
					if(i==0) {
						...
						while(iter.hasNext()){
	        				...
	        				switch (i) {
							case 1:
								if (rs.getInt("year") == 1997 && fs.cust.equals(rs.getString("cust")) && rs.getString("state").equals("NY")) {
								...
								if (rs.getInt("year") == 1997 && fs.cust.equals(rs.getString("cust")) && rs.getString("state").equals("CT")) {
								...
								if (rs.getInt("year") == 1997 && fs.cust.equals(rs.getString("cust")) && rs.getString("state").equals("NJ")) {
									map.get(key).sum_quant_3 += rs.getInt("quant");
									map.get(key).cnt_quant_3 ++;
									map.get(key).avg_quant_3 = (int) (map.get(key).sum_quant_3/map.get(key).cnt_quant_3);
								}
								break;
	        				default:
	            				break;
